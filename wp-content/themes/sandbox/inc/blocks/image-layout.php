...
function sandbox_register_image_layout_block()
{
	...
	register_block_type(
		...
		array(
			...
			'attributes' => array(
				'eyebrow' => array('type' => 'string', 'default' => __('Image layout', 'sandbox')),
				'title' => array('type' => 'string', 'default' => __('Show your product experience visually.', 'sandbox')),
				'imageOneUrl' => array('type' => 'string', 'default' => 'https://picsum.photos/900/620?random=11'),
				'imageOneAlt' => array('type' => 'string', 'default' => __('Students watching an online session', 'sandbox')),
				'imageOneCaption' => array('type' => 'string', 'default' => __('Live cohort sessions and guided lessons.', 'sandbox')),
				'imageTwoUrl' => array('type' => 'string', 'default' => 'https://picsum.photos/620/420?random=12'),
				'imageTwoAlt' => array('type' => 'string', 'default' => __('Instructor dashboard', 'sandbox')),
				'imageTwoCaption' => array('type' => 'string', 'default' => __('Simple instructor dashboard to manage modules.', 'sandbox')),
				'imageThreeUrl' => array('type' => 'string', 'default' => 'https://picsum.photos/620/420?random=13'),
				'imageThreeAlt' => array('type' => 'string', 'default' => __('Mobile learning screen', 'sandbox')),
				'imageThreeCaption' => array('type' => 'string', 'default' => __('Learner-friendly experience across devices.', 'sandbox')),
			),
		)
	);
}
